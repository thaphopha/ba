...
class ArxivTool(BaseTool):
    ...
    def __init__(self, download_pdfs: bool = True, save_dir: str = "./pdfs", search_terms: Optional[List[str]] = None, use_title_as_filename: bool = False, default_max_results: int = 50, **kwargs):
        ...
        super().__init__(
            ...
            default_max_results=int(default_max_results) if default_max_results is not None else 50,
            **kwargs
        )
